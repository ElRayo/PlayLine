...
class QTRSensors
{
  public:
	...
	void setSelectorPins(const uint8_t * selectPins, uint8_t selectCount);

	void setEnablePins(const uint8_t * enablePins, uint8_t enableCount);
  ...
  private:
    ...
    uint8_t * _enablePins = nullptr;
    uint8_t _enableCount = 0;
	
	uint8_t * _selectPins = nullptr;
    uint8_t _selectCount = 0;
